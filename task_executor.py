...
class TaskExecutor:
    ...
    def execute(self, task: str):
        ...
        # Coding
        if self.code_sampling_strategy == NO_SAMPLING:
            for i in range(self.max_coding_attempts):
        ...
        elif self.code_sampling_strategy == PYLINT:
            coding_samples = []
            for i in range(self.coding_samples):
                # self.coder.llm.set_parameter(
                #     "temperature", i * self.sampling_temperature_multipler)
